...
describe('/pets/{petId}/{petAge}/{petColor}', function() {
  describe('get', function() {
    it('should respond with 200 successful operation', function(done) {
      ...
      /*eslint-enable*/
      api.get('/v2/pets/{petId PARAM GOES HERE}/{petAge PARAM GOES HERE}/{petColor PARAM GOES HERE}')
      .query({
qp1: 'DATA GOES HERE',qp2: 'DATA GOES HERE'
      })
...
qp1: 'DATA GOES HERE',qp2: 'DATA GOES HERE'
  ...
  describe('post', function() {
    it('should respond with 405 Invalid input', function(done) {
      api.post('/v2/pets/{petId PARAM GOES HERE}/{petAge PARAM GOES HERE}/{petColor PARAM GOES HERE}')
  ...
  describe('delete', function() {
    it('should respond with 400 Invalid pet value', function(done) {
      api.del('/v2/pets/{petId PARAM GOES HERE}/{petAge PARAM GOES HERE}/{petColor PARAM GOES HERE}')
      .set('Authorization', 'Bearer ' + process.env.PETSTORE_AUTH)
      .set('Accept', 'application/json')
      .set({
